...
const OrgTab = () => {
    ...
    return (
        hasHydrated ? (
            <div className='p4'>
                <div className='flex justify-between w-full cursor-pointer items-center gap-2.5 max-lg:gap-2 max-md:gap-1.5 max-md:w-max bg-secondary/30 rounded-x2l max-lg:p-2 max-md:p-1.5 p-2.5'>
