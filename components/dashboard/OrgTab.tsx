    ...
    return (
        hasHydrated ? (
            <div className='p-4 max-md:p-1'>
                <Link href="/profile/organisation" prefetch className='flex justify-between w-full cursor-pointer items-center gap-2.5 max-lg:gap-2 max-md:gap-1.5 max-md:w-max bg-secondary/80 hover:bg-secondary transition duration-300 rounded-x2l max-lg:p-2 max-md:p-1.5 p-2.5'>
                    <div className='flex items-center gap-2'>
                        <div className='max-lg:w-10 w-12 h-12 max-md:w-8 uppercase flex items-center justify-center xl font-bold text-white bg-primary rounded-gl max-lg:h-10 max-md:h-8'>
