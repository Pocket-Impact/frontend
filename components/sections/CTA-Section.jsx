    ...
    return (
        <div className='p-20 max-lg:p-16 max-md:p-12 max-sm:p-8 flex flex-col items-center rounded-2xl'>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
                ...
                <button className="rounded-xl bg-black/5 text-black cursor-pointer hover:bg-black/10 transition duration-300 inter font-semibold py-4 max-md:py-2 px-8 max-md:px-4">
                    Book a Demo
                </button>
            </div>
        </div>
