...
const FooterSection = () => {
    return (
        <footer className='bg-primary px-10 pt-10 rounded-t-3xl'>
            <div className='flex border-b pb-10 border-white/30 justify-between gap-20'>
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='flex gap-4'>
                        {icons.map((icon, index) => (
                            <div className='bg-white/80 hover:bg-white/100 transition duration-300 p-2 max-md:p-1.5 rounded-lg' key={index} aria-label={`${icon.name} payment method`} role="img">
                ...
                <div className='text-white inter'>
                    <h2 className='base font-bold text-white text-right'>Links</h2>
