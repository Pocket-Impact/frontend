...
const FeaturesSection = () => {
    return (
        <section id='features' className='scroll-mt-32 inter mb-16 max-lg:h-max max-md:pt-16 px-24 max-lg:p-8 max-md:p-6 max-sm:p-4 flex flex-col items-center text-black' aria-labelledby="features-heading">
            <div className='flex flex-col text-center items-center'>
                ...
                <h1 id="features-heading" className='font-bold bricolage x5l mb-4 mt-3'>Everything You Need in <br /> One Pocket</h1>
