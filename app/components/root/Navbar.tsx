...
const Navbar = () => {
    return (
        <>
            ...
            <div className='max-md:flex hidden px-4 bg-background rounded-b-2xl fixed w-full max-w-[1440px] justify-between inter h-16 items-center p-2 left-1/2 top-0 -translate-x-[50%] z-10'>
                <div className='flex items-center gap-2'>
                    <Image src={logo} alt="Pocket Impact Logo" width={logo.width} height={logo.height} className='w-8 h-8' />
                    <span className='bricolage xl'>
                        Pocket Impact
                ...
                <div>
                    <PrimaryButton icon={<CiMenuFries />} styles="text-sm p-3" />
                </div>
            </div>
        </>
    )
